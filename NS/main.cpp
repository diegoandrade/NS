...
int main(int argc, char * argv[]) {
   ...
   // REAL ** m = RMATRIX(0.,  imax+2,  jmax+2);
    ...
    REAL ** d2uy = RMATRIX(0.,  imax+2,  jmax+2);
    REAL ** d1u2x = RMATRIX(0.,  imax+2,  jmax+2);
    REAL ** d1uvy = RMATRIX(0.,  imax+2,  jmax+2);
    REAL ** d2vx = RMATRIX(0.,  imax+2,  jmax+2);
    REAL ** d2vy = RMATRIX(0.,  imax+2,  jmax+2);
    REAL ** d1v2y = RMATRIX(0.,  imax+2,  jmax+2);
    REAL ** d1uvx = RMATRIX(0.,  imax+2,  jmax+2);
